...
function Register(){
    ...
    const checkinp = (e) => {
        ...
        if (e.target.id === "name")
        {
            ...
            if (products.some(product => product.name.toLowerCase() === value.toLowerCase()))
            {
    ...
    const valall = () => {
        ...
        if (!formHasError) {
                axios.post('https://retoolapi.dev/NRdH0u/products', product)
        ...
        <>
            <form className="needs-validation m-5" noValidate style={{width: '25%', border: "1px solid black", padding: "20px", borderRadius: '10px'}} onSubmit={(e) => e.preventDefault()} ref={formRef}>
                <div className="" >
                    ...
                    <Input idn="desc" inlabl="Descreption" intype="text" valmsg={valmsg} invalmsg={invalmsg} blurfun={checkinp} chgfun={resetval} isinvalid={isinValid.description} isvalid={isValid.description}/>
                    ...
                    <div className="mb-5">
                        ...
                        <select id="category" name="category" onChange={handleCategoryChange} className="bg-gray-50 border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <Input idn="price" inlabl="Price" intype="text" valmsg={valmsg} invalmsg={invalmsg} blurfun={checkinp} chgfun={resetval} isinvalid={isinValid.price} isvalid={isValid.price}/>
                    <Input idn="quant" inlabl="Quantaty" intype="text" valmsg={valmsg} invalmsg={invalmsg} blurfun={checkinp} chgfun={resetval} isinvalid={isinValid.quantaty} isvalid={isValid.quantaty}/>
                    <Input idn="image" inlabl="Image" intype="text" valmsg={valmsg} invalmsg={invalmsg} blurfun={checkinp} chgfun={resetval} isinvalid={isinValid.image} isvalid={isValid.image}/>
                    


                    <div className='flex justify-between'>
                        <Button bclr="green" title1="Add product" mar="15px" clck={valall}/>
                        {alertVisible && (
                            ...
                            <span className="font-medium"></span>Succesfully added.
                            </div>
                        )}
